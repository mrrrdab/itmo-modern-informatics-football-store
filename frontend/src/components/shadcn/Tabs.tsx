...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'whitespace-nowrap text-center overflow-x-auto rounded-lg bg-zinc-100 p-1 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400 sm:whitespace-normal',
      className,
    )}
    {...props}
  />
